      ...
      <div className="flex-1 flex flex-col justify-center items-center p-6 sm:p-12 overflow-y-auto relative">
        ...
        <div className="w-full max-w-md animate-fade-up">
          ...
          <button
            ...
            disabled={loading}
            className="w-full bg-white border border-stone-200 hover:border-stone-300 hover:bg-stone-50 text-stone-700 font-medium py-3 px-6 rounded-xl transition-all text-sm flex items-center justify-center gap-3 shadow-sm disabled:opacity-50"
          >
